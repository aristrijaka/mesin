...
class cs_widget_data {
    ...
    public function __construct() {
        ...
        add_action('wp_ajax_cs_widget_file_delete', array(__CLASS__, 'cs_widget_file_delete'));
    }
    ...
    public static function enqueue_admin_scripts($hook) {
        ...
        wp_enqueue_style('widget_data', cs_framework::plugin_url() . 'assets/css/widget-data.css');
        wp_enqueue_script('widget_data', cs_framework::plugin_url() . 'assets/js/widget-data.js', '', '', true);
        ...
        <div class="widget-data cs-export-widget-settings">
            ...
            <div class="cs-export-wrapper">
                ...
                <div id="cs-widget-export-form">
                    <div class="title">
                        <h3>Widget Setting Export</h3>
                        <span class="cs-select-butns">
                            <a class="select-all">Select All</a>
                            <a class="unselect-all">Un-Select All</a>
                        </span>
                        <div class="clear"></div>
                    </div>
                    <div class="sidebars">
                    ...
                    <input id="cs-export-wgts-btn" type="button" value="Generate Widget Settings"/>
                </div>
            </div>
    ...
    public static function import_settings_page() {
        ...
        <div class="widget-data import-widget-settings">
            <?php if (isset($_POST['file_name']) && $_POST['file_name'] != '') : ?>
                ...
                <div class="cs-import-wrapper">
                    ...
                    <div id="cs-import-widget-form">
                        ...
                        <div class="title">
                            ...
                            <span class="cs-select-butns">
                                <a class="imp-select-all">Select All</a>
                                <a class="imp-unselect-all">Un-Select All</a>
                            </span>
                            <div class="clear"></div>
                        </div>
                        <div class="sidebars">
                ...
                ?>
                <p>Put File URL that contains widget settings</p>
                <p>
                    <input type="text" id="cs-widget-upload-file" />
                </p>
                <input type="button" id="widget-import-submit" class="button" value="Show Widget Settings" />
            <?php endif; ?>
    ...
    public static function export_widget_settings() {
        ...
        if (isset($_POST['action']) && $_POST['action'] == 'export_widget_settings') {
            ...
            $cs_filename = trailingslashit($cs_upload_dir) . 'widget_' . (current_time('d-M-Y_H.i.s')) . '.json';

            $cs_widgets_file = self::parse_export_data($_POST);

            if (!$wp_filesystem->put_contents($cs_filename, $cs_widgets_file, FS_CHMOD_FILE)) {
                echo __("Error saving file!", "cs_frame");
            } else {
                echo __("Backup Generated.", "cs_frame");
            }
        }
        die;
    }

    public static function cs_widget_file_delete() {
        ...
        if (is_file($cs_filename)) {
            unlink($cs_filename);
            printf(__("File '%s' Deleted Successfully", "cs_frame"), $file_name);
        } else {
            echo __("Error Deleting file!", "cs_frame");
        }
     ...
     */
    public static function cs_import_widget_data() {
        ...
        $cs_upload_dir = cs_framework::plugin_dir() . 'include/cs-importer/import-widgets/';

        $file_name = 'import-widgets.json';

        $import_file = trailingslashit($cs_upload_dir) . $file_name;
        ...
        echo '<p><strong>' . __('Widgets Imported Successfully.', 'cs_frame') . '</strong><br />';
    }
...
$cs_widget_data = new cs_widget_data();
