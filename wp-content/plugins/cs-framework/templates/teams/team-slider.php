                        ...
                        <div class="graybackground">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 style="color:<?php echo esc_html($cs_team_title_color); ?> !important"><a href="<?php esc_url(the_permalink()); ?>"  style="color:#FFF !important;"><?php the_title(); ?></a></h4>
                                    ...
                                    <?php if ($cs_team_post_description == 'yes' and $cs_team_specs_desc <> '') { ?>
                                    ...
                                    <div class="contactdiv">
                                        <ul>
                                            ...
                                            <?php } if ($cs_team_phone <> '') { ?>
                                                ...
                                                <li><span><i class="icon-phone6"></i></span> <?php echo esc_html($cs_team_phone); ?>  </li>
                                            <?php } ?>              </ul>
                                    </div>
