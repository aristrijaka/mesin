...
if (!class_exists('cs_flickr')) {
    ...
    class cs_flickr extends WP_Widget {
         ...
         * @init Flickr Module
         *
         *  widget col-md-3 widget_gallery
         */
        public function __construct() {

            parent::__construct(
                    'cs_flickr', // Base ID
                    __('CS : Flickr Gallery', 'uoc'), // Name
        ...
        function form($instance) {
            ...
            <p>
                <label for="<?php echo cs_allow_special_char($this->get_field_id('username')); ?>"><?php _e('Flickr username', 'uoc'); ?> 
            ...
            <p>
                <label for="<?php echo cs_allow_special_char($this->get_field_id('no_of_photos')); ?>"><?php _e('Number of Photos', 'uoc'); ?> 
            ...
            if ($apiKey <> '') {
                ...
                if ($check_transient === false || ($apiKey <> $db_apiKey || $username <> $db_user_name || $no_of_photos <> $db_total_photos)) {
                    ...
                    if (get_option('flickr_gallery_data') <> '') {
                        ...
                        _e('No result found.', 'uoc');
                    }
                }
            } else {
                _e('Please Enter Flickr API key from Theme Options.', 'uoc');
            }
