        ...
        if (isset($_POST['builder_active'])) {
            ...
            if (isset($_POST['total_column'])) {
                foreach ($_POST['total_column'] as $count_column) {
                    ...
                    if (empty($_POST['cs_section_flex_slider'][$column_container_no]))
                        $_POST['cs_section_flex_slider'][$column_container_no] = "";
                        ...
                        for ($j = 1; $j <= $a; $j++) {
                            ...
                            /* Call to action */ else if ($_POST['cs_orderby'][$cs_counter] == "call_to_action") {
                                ...
                                if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                    ...
                                    if (isset($_POST['cs_call_to_action_text'][$cs_counter_call_to_action]) && $_POST['cs_call_to_action_text'][$cs_counter_call_to_action] != '') {
                                        $shortcode .= ' cs_call_to_action_text="' . htmlspecialchars($_POST['cs_call_to_action_text'][$cs_counter_call_to_action], ENT_QUOTES) . '" ';
                                    }
                                    if (isset($_POST['cs_call_view'][$cs_counter_call_to_action]) && $_POST['cs_call_view'][$cs_counter_call_to_action] != '') {
                                        $shortcode .= ' cs_call_view="' . htmlspecialchars($_POST['cs_call_view'][$cs_counter_call_to_action], ENT_QUOTES) . '" ';
                                    }


                                    if (isset($_POST['cs_call_to_action_view'][$cs_counter_call_to_action]) && $_POST['cs_call_to_action_view'][$cs_counter_call_to_action] != '') {
                                        $shortcode .= ' cs_call_to_action_view="' . htmlspecialchars($_POST['cs_call_to_action_view'][$cs_counter_call_to_action], ENT_QUOTES) . '" ';
                                    }
                            ...
                            /*                             * **********************Gallery*************************** */ else if ($_POST['cs_orderby'][$cs_counter] == "gallery") {
                                $shortcode = '';
                            ...
                            /*                             * **************************Categories******************************* */ else if ($_POST['cs_orderby'][$cs_counter] == "job_specialisms") {
                                $shortcode = '';
                            ...
                            /*                             * ***************course************************ */ else if ($_POST['cs_orderby'][$cs_counter] == "course") {
                                $shortcode = '';
                            ...
                            /*                             * ***************course************************ */ else if ($_POST['cs_orderby'][$cs_counter] == "rooms") {
                                $shortcode = '';
                            ...
                            // Save Twitter page element 
                                ...
                                if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                    ...
                                    echo $_POST['cs_tweets_bg'][$cs_counter_tweets];
                                    ...
                                    if (isset($_POST['cs_tweets'][$cs_counter_tweets]) && $_POST['cs_tweets'][$cs_counter_tweets] != '') {
                                        $shortcode .='cs_tweets="' . htmlspecialchars($_POST['cs_tweets'][$cs_counter_tweets]) . '" ';
                                    }
                                    if (isset($_POST['cs_tweets_bg'][$cs_counter_tweets]) && $_POST['cs_tweets_bg'][$cs_counter_tweets] != '') {
                                        $shortcode .='cs_tweets_bg="' . htmlspecialchars($_POST['cs_tweets_bg'][$cs_counter_tweets]) . '" ';
                                    }
