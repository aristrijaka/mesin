...
if (!function_exists('cs_gallery_shortcode')) {
                ...
                if ($cs_meta_gallery_options <> "") {
                    for ($i = $limit_start; $i < $limit_end; $i++) {
                        ...
                        if (isset($image_url_full) && $image_url_full != "") {
                            ...
                            $html .= '<figure>';
                            $html .= '<a rel="prettyPhoto[gallery-four-col]>" data-title="' . esc_html($image_title) . '"  href="' . esc_url($image_url_full) . '">' . "<img src='" . esc_url($image_url_full) . "' data-alt='" . $image_title . "' alt='" . $image_title . "' />" . '</a>';
                ...
                if ($cs_meta_gallery_options <> "") {
                    for ($i = $limit_start; $i < $limit_end; $i++) {
                        ...
                        if (isset($image_url_full) && $image_url_full != "") {
                            ...
                            $html .= '<figure>';
                            $html .= '<a rel="prettyPhoto[gallery-wordpress]>" data-title="' . esc_html($image_title) . '"  href="' . esc_url($image_url_full) . '">' . "<img src='" . esc_url($image_url_full) . "' data-alt='" . $image_title . "' alt='" . $image_title . "' />" . '</a>';
                ...
                if ($cs_meta_gallery_options <> "") {
                    ...
                    for ($i = $limit_start; $i < $limit_end; $i++) {
                        ...
                        if (isset($image_url_full) && $image_url_full != "") {
                            $html .= '<article class="item col-md-3 has_border">';
                            $html .= '<figure>';
                            $html .= '<a rel="prettyPhoto[gallery-masonry]>" target="" data-title="' . esc_html($image_title) . '"  href="' . esc_url($image_url_full) . '">' . "<img src='" . $image_url_full . "' data-alt='" . $image_title . "' alt='" . $image_title . "' />" . '</a>';
    ...
    if (function_exists('cs_short_code')) {
        cs_short_code('cs_gallery', 'cs_gallery_shortcode');
    }
}
