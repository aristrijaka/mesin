            ...
            <div class="cs-media-attachment mediaelements-post">
                ...
                foreach ($attachments as $attachment) {
                    ...
                    if ($type == 'image/jpeg') {
                        ...
                        ?> href="<?php echo esc_url($attachment->guid); ?>" rel="<?php echo "prettyPhoto[gallery1]" ?>" class="me-imgbox">
...
if (!function_exists('cs_shortcode_element_size')) {
    ...
    function cs_shortcode_element_size($column_size = '') {
        ...
        ?>><?php _e('Full width', 'uoc'); ?></option>
                    <option value="1/2" <?php
                            if ($column_size == '1/2') {
                                echo 'selected="selected"';
                            }
                            ?>><?php _e('One half', 'uoc'); ?></option>
                    <option value="1/3" <?php
                    if ($column_size == '1/3') {
                        echo 'selected="selected"';
                    }
                    ?>><?php _e('One third', 'uoc'); ?></option
                    ><option value="2/3" <?php
            if ($column_size == '2/3') {
                echo 'selected="selected"';
            }
            ?>><?php _e('Two third', 'uoc'); ?></option>
                    <option value="1/4" <?php
        if ($column_size == '1/4') {
            echo 'selected="selected"';
        }
        ?>><?php _e('One fourth', 'uoc'); ?></option>
                    <option value="3/4" <?php
        if ($column_size == '3/4') {
            echo 'selected="selected"';
        }
        ?>><?php _e('Three fourth', 'uoc'); ?></option>
                </select>
            ...
            if (isset($_POST['shortcode_element']) && $_POST['shortcode_element']) {
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo cs_allow_special_char($multiple_services_count); ?>">
                    ...
                    <ul class="form-elements">
                        ...
                        <div class='left-info'>
                            <p> <?php esc_html_e('Select the Background Color Only For Modern View', 'cars'); ?></p>
                        </div>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Website Url', 'uoc'); ?></label></li>
