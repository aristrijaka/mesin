 ...
 */
if ( ! function_exists( 'cs_pb_sitemap' ) ) {
    function cs_pb_sitemap($die = 0){
        global $cs_node, $post;
        $shortcode_element = '';
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete column_100 column_100 <?php echo esc_attr($shortcode_view);?>" item="sitemap" data="0" >
  ...
  <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter);?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[<?php echo esc_attr( CS_SC_SITEMAP );?> {{attributes}}]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit SITEMAP Options','uoc');?></h5>
    ...
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Section Titles','uoc');?></label>
          </li>
            <li class="to-field">
                    <input  name="cs_sitemap_section_title[]" type="text"  value="<?php echo cs_allow_special_char($cs_sitemap_section_title);?>"   />
                </li>   
        </ul>
      </div>
      ...
      <ul class="form-elements noborder">
        ...
        <li class="to-field">
          <input type="hidden" name="cs_orderby[]" value="sitemap" />
...
<?php
    ...
    add_action('wp_ajax_cs_pb_sitemap', 'cs_pb_sitemap');
}
