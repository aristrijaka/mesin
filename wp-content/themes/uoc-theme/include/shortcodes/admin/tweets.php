...
if ( ! function_exists( 'cs_pb_tweets' ) ) {
    function cs_pb_tweets($die = 0){
        ...
        $defaults = array('cs_tweets_section_title' => '','cs_tweets_user_name' => 'default','cs_no_of_tweets' => '','cs_tweets'=>'','cs_tweets_class' => '','cs_tweets_bg'=>'');
    ...
    ?>
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="tweets" data="<?php echo cs_element_size_data_array_index($tweets_element_size)?>" >
                     ...
                     <div class="cs-wrapp-clone cs-shortcode-wrapp">
                       <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){cs_shortcode_element_size();}?>                   
                            ...
                            <ul class="form-elements">
                                ...
                                <li class="to-field">
                                    <input type="text" name="cs_tweets[]" class="bg_color"  value="<?php echo esc_attr($cs_tweets)?>" />
                                </li>
                            </ul>
                             <ul class="form-elements">
                                <li class="to-label"><label><?php _e('Background Color','uoc');?></label></li>
                                <li class="to-field">
                                    <input type="text" name="cs_tweets_bg[]" class="bg_color"  value="<?php echo esc_attr($cs_tweets_bg)?>" />
                                </li>
                            </ul>
                            <ul class="form-elements">
                              <li class="to-label">
