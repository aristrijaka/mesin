...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?>
	  ...
	  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?>
		...
		<div class="cs-heading-area">
			  <h5><?php _e('Edit Flex Column Options','uoc');?></h5>
    ...
    <div class="cs-pbwp-content">
          ...
          <li class="to-label">
            <label><?php _e('Background Image','uoc');
          ...
          <ul class="form-elements">
            ...
            <li class="to-field">
              <div class='input-sec'>
				...
				<ul class="form-elements">
					  <li class="to-label">
						<label><?php _e('Column Text','uoc');?></label>
					  </li>
					  <li class="to-field">
                        <textarea name="flex_column_text[]" data-content-text="cs-shortcode-textarea"><?php echo esc_textarea(cs_custom_shortcode_decode($flex_column_text))?></textarea>
      ...
      <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){?>
		  <ul class="form-elements insert-bg">
			<li class="to-field">
				<a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo str_replace('cs_pb_','',$name);?>','<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" ><?php _e('Insert','uoc');?></a>
			</li>
		  </ul>
