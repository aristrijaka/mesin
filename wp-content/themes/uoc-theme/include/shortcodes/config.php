...
define('CS_SC_CATEGORIES','cs_categories');
define('CS_SC_COLUMN','cs_column');
define('CS_SC_LIST','cs_list');
define('CS_SC_LISTITEM','list_item');
define('CS_SC_OPENINGHOURS','cs_opening');
define('CS_SC_OPENINGHOURS_LISTITEM','opening_item');
...
define('CS_SC_SEARCH','cs_search');
//Translation
__('Call To Action','uoc');
__('Contactus','uoc');
__('Faq','uoc');
__('Flex Column','uoc');
__('Teams','uoc');
