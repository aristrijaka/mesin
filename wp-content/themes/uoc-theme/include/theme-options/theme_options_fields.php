            ...
            switch ($value['type']) {
                ...
                case 'text':
                    ...
                    $output .= '<li class="to-label">
                                ...
                                <li class="to-field"><input   name="' . $value['id'] . '" id="' . $value['id'] . '" type="' . $value['type'] . '" value="' . esc_html($val) . '" class="vsmall" />';
                ...
                case 'generate_backup':
					...
					<div class="cs-import-help">
						<h4>' . __('Import Options', 'uoc') . '</h4>
					</div>';

                    $output .= '<div class="external_backup_areas">';

                    $output .= '<p>' . __('Input the URL from another location and hit Import Button to apply settings.', 'uoc') . '</p>';

                    $output .= '<input type="text" id="bkup_import_url" />';
                    $output .= '<input id="cs-backup-url-restore" type="button" value="' . __('Import', 'uoc') . '" />';

                    $output .= '</div>';

                    $output .= '
					<div class="cs-import-help">
						<h4>' . __('Export Options', 'uoc') . '</h4>
					</div>';

                    if (is_array($cs_all_list) && sizeof($cs_all_list) > 0) {

                        $output .= '<p>' . __('Here you can Generate/Download Backups. Also you can use these Backups to Restore settings.', 'uoc') . '</p>';

                        $output .= '<select onchange="cs_set_filename(this.value, \'' . esc_url($cs_upload_dir_path) . '\')">';
                        ...
                        if (isset($file_val['name'])) {
                            ...
                            $output .= '<input id="cs-backup-restore" data-file="' . $file_val['name'] . '" type="button" value="' . __('Restore', 'uoc') . '" />';

                            $output .= '<a download="' . $file_val['name'] . '" href="' . esc_js($cs_upload_dir_path . $file_val['name']) . '">' . __('Download', 'uoc') . '</a>';

                            $output .= '<input id="cs-backup-delte" data-file="' . $file_val['name'] . '" type="button" value="' . __('Delete', 'uoc') . '" />';
                        }

                        $output .= '</div>';
                    }

                    $output .= '<input type="button" value="' . __('Generate Backup', 'uoc') . '" onclick="javascript:cs_backup_generate(\'' . esc_js(admin_url('admin-ajax.php')) . '\');" />';
                    ...
                    if (class_exists('cs_widget_data')) {
                        ...
                        if (is_array($cs_all_list) && sizeof($cs_all_list) > 0) {
                            ...
                            if (isset($file_val['name'])) {
                                ...
                                $output .= '<input id="cs-wid-backup-restore" data-path="' . $cs_upload_dir_path . '" data-file="' . $file_val['name'] . '" type="button" value="' . __('Show Widget Settings', 'uoc') . '" />';

                                $output .= '<a download="' . $file_val['name'] . '" href="' . $cs_upload_dir_path . $file_val['name'] . '">' . __('Download', 'uoc') . '</a>';

                                $output .= '<input id="cs-wid-backup-delte" data-file="' . $file_val['name'] . '" type="button" value="' . __('Delete', 'uoc') . '" />';
                            }
                ...
                case 'select_sidebar':
                    ...
                    if (isset($value['options']['sidebar']) && is_array($value['options']['sidebar'])) {
                ...
                case "upload":
                    ...
                    $output .= '<ul class="form-elements" id="' . $value['id'] . '_upload">
                                  ...
                                  <li class="to-field">
                                    ...
                                    <input name="' . $value['id'] . '"  type="button" class="uploadMedia left" value="' . __('Browse', 'uoc') . '"/></label>
                                  </li>
                                </ul>';
                ...
                case "upload logo":
                    ...
                    $output .= '<ul class="form-elements" id="' . $value['id'] . '_upload">
                                  ...
                                  <li class="to-field">
                                    ...
                                    <input id="' . $value['id'] . '" name="' . $value['id'] . '" type="hidden" class="" value="' . $val . '"/>
                                    <label class="browse-icon"><input name="' . $value['id'] . '"  type="button" class="uploadMedia left" value="' . __('Browse', 'uoc') . '"/></label>
                                  </li>
                                </ul>';
                ...
                case "upload font":
                    ...
                    $output .= '<ul class="form-elements" id="' . $value['id'] . '_upload">
                                  ...
                                  <li class="to-field">
                                    ...
                                    <label class="browse-icon">
                                        <input name="' . $value['id'] . '" type="button" class="uploadMedia left" value="' . __('Browse', 'uoc') . '"/>
                                    </label>
                                  </li>
                                </ul>';
                    break;
                ...
                case "upload favicon":
                    ...
                    $output .= '<label class="cs-browse"><input id="log" name="' . $value['id'] . '" type="button" class="uploadfile left" value="' . __('Browse', 'uoc') . '"/><i class="icon-upload"></i></label></div></li></ul>';
                ...
                case "sidebar":
                    ...
                    $output .= '<ul class="form-elements">
                                    <li class="to-label">
                                        <label>' . esc_attr($value['name']) . ' <span>' . __("Please enter the desired title of sidebar", 'uoc') . '</span></label>
                                    </li>
                                    <li class="to-field">
                                        <input class="small" type="text" name="sidebar_input" id="sidebar_input"/>
                                        <input type="button" value=' . __("Add Sidebar", 'uoc') . ' onclick="javascript:add_sidebar()" />
                                    </li>
                                </ul>
                                <div class="clear"></div>
                                <div class="sidebar-area" style="display:' . $display . '">
                                    <div class="theme-help">
                                      <h4 style="padding-bottom:0px;">' . __('Already Added Sidebars', 'uoc') . '</h4>
                                      <div class="clear"></div>
                                    </div>
                                    <div class="boxes">
                                        ...
                                        <thead>
                                            <tr>
                                                <th>' . __('Sider Bar Name', 'uoc') . '</th>
                                                <th class="centr">' . __("Actions", 'uoc') . '</th>
                                            </tr>
                                        </thead>
                ...
                case "networks":
                    ...
                    $output.='<ul class="form-elements">
                                <li class="to-label">
                                  <label>' . __("Title", 'uoc') . ' <span>' . __("Please enter text for icon", "uoc") . '</span></label>
                                </li>
                                <li class="to-field">
                                ...
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __("Url", 'uoc') . ' <span>' . __("Please enter Full Url", "uoc") . '</span></label>
                                </li>
                                <li class="to-field">
                                ...
                                <div class="input-sec">
                                  ...
                                  <label class="browse-icon"><input id="social_net_icon_path_input" name="social_net_icon_path_input" type="button" class="uploadMedia left" value="' . __('Browse', 'uoc') . '"/></label>
                               </li>
                              ...
                              <li class="to-label">
                                <label>' . __('FontAwesome Color', 'uoc') . '<span></span></label>
                              </li>
                              <li class="to-field">
                                <div class="input-sec">
                                ...
                                <li class="to-field" style="width:100%;">
                                  <input type="button" value="' . __("Add", 'uoc') . '" onclick=javascript:cs_add_social_icon("' . admin_url("admin-ajax.php") . '") style="float:right;" />
                                </li>
                              </ul>
                              <div class="clear"></div>
                              <div class="social-area" style="display:' . $display . '">
                              <div class="theme-help">
                                <h4 style="padding-bottom:0px;">' . __("Already Added Social Icons", 'uoc') . '</h4>
                                <div class="clear"></div>
                              </div>
                              <div class="boxes">
                              <table class="to-table" border="0" cellspacing="0">
                                  <thead>
                                    <tr>
                                      <th>' . __("Icon Path", 'uoc') . '</th>
                                      <th>' . __("Network Name", 'uoc') . '</th>
                                      <th>' . __("Url", 'uoc') . '</th>
                                      <th class="centr">' . __("Actions Icon", 'uoc') . '</th>
                                    </tr>
                                  </thead>
                                ...
                                $output.='<tr id="' . str_replace(' ', '-', $social_net_tooltip[$i]) . '" style="display:none">
                                                      ...
                                                      <li><a onclick="cs_toggle(\'' . str_replace(' ', '-', $social_net_tooltip[$i]) . '\')"><img src="' . get_template_directory_uri() . '/include/assets/images/close-red.png" /></a></li>
                                                          ...
                                                          <li class="to-field">
                                                            ...
                                                            <label class="browse-icon"><input id="social_net_icon_path' . $i . '" name="social_net_icon_path' . $i . '" type="button" class="uploadMedia left" value="' . __('Browse', 'uoc') . '"/></label>
                                                          </li>
                                                          ...
                                                          <li class="to-label">
                                                            <label>' . __("Font Awesome Color", 'uoc') . '</label>
                                                          </li>
                                                          <li class="to-field">
                                                            <div class="input-sec">
                ...
                case "banner_fields":
                    ...
                    $output.='<ul class="form-elements">
                                <li class="to-label">
                                  <label>' . __('Title', 'uoc') . ' <span>' . __('Please enter Banner Title', 'uoc') . '</span></label>
                                </li>
                                <li class="to-field">
                                ...
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __('Banner Style', 'uoc') . '  <span>' . __('Please enter Banner Banner Style', 'uoc') . '</span></label>
                                </li>
                                <li class="to-field select-style">
                                  <select id="banner_style_input">
                                    <option value="top_banner">' . __('Top Banner', 'uoc') . '</option>
                                    <option value="bottom_banner">' . __('Bottom Banner', 'uoc') . '</option>
                                    <option value="sidebar_banner">' . __('Sidebar Banner', 'uoc') . '</option>
                                    <option value="vertical_banner">' . __('Vertical Banner', 'uoc') . '</option>
                                  </select>
                                </li>
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __('Banner Type', 'uoc') . ' <span>' . __('Please enter Banner Banner Type', 'uoc') . '</span></label>
                                </li>
                                <li class="to-field select-style">
                                  <select id="banner_type_input" onchange="cs_banner_type_toggle(this.value, \'' . $cs_rand_id . '\')">
                                    <option value="image">' . __('Image', 'uoc') . '</option>
                                    <option value="code">' . __('Code', 'uoc') . '</option>
                                  </select>
                                </li>
                                <li class="full">&nbsp;</li>
                                <li class="to-label" id="cs_banner_image_field_' . $cs_rand_id . '">
                                  <label>' . __('Image', 'uoc') . ' <span>' . __('Please enter Banner Image', 'uoc') . '</span></label>
                                </li>
                                ...
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __('Url', 'uoc') . ' <span>' . __('Please enter Banner Url', 'uoc') . '</span></label>
                                </li>
                                <li class="to-field">
                                ...
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __('Target', 'uoc') . ' <span>' . __('Please select Banner Link Target', 'uoc') . '</span></label>
                                </li>
                                <li class="to-field select-style">
                                  <select id="banner_field_url_target_input">
                                    <option value="_self">' . __('Self', 'uoc') . '</option>
                                    <option value="_blank">' . __('Blank', 'uoc') . '</option>
                                  </select>
                                </li>
                                <li class="full">&nbsp;</li>
                                <li class="to-label" id="cs_banner_code_field_' . $cs_rand_id . '" style="display:none;">
                                  <label>' . __('Adsense Code', 'uoc') . ' <span>' . __('Please enter Banner Ad sense Code', 'uoc') . '</span></label>
                                </li>
                                ...
                                <li class="to-field" style="width:100%;">
                                  ...
                                  <input type="button" value="' . __('Add', 'uoc') . '" onclick=javascript:cs_add_banner_fields("' . admin_url("admin-ajax.php") . '","' . esc_js(get_template_directory_uri()) . '","' . $cs_rand_id . '") style="float:right;" />
                                </li>
                              </ul>
                              <div class="clear"></div>
                              <div class="banner-fields-area" style="display:' . $display . '">
                              <div class="theme-help">
                                <h4 style="padding-bottom:0px;">' . __('Already Added Banners', 'uoc') . '</h4>
                                <div class="clear"></div>
                              </div>
                              <div class="boxes">
                              <table class="to-table" border="0" cellspacing="0">
                        ...
                        foreach ($banner_fields as $field) {
                            ...
                            if (isset($banner_fields[$i]) || isset($banner_fields[$i])) {
                                ...
                                if ($banner_fields_type[$i] == 'image') {
                                    ...
                                    $output .= '<td>' . __('Custom Code', 'uoc') . '</td>';
                                }
                                if ($banner_fields_type[$i] == 'image') {
                                ...
                                $output.='<tr id="' . cs_slugify_text($banner_fields[$i]) . '" style="display:none">
                                          ...
                                          <li><a onclick="cs_toggle(\'' . cs_slugify_text($banner_fields[$i]) . '\')"><img src="' . get_template_directory_uri() . '/include/assets/images/close-red.png" /></a></li>
                                              ...
                                              <li class="full">&nbsp;</li>
                                              <li class="to-label">
                                                <label>' . __('Banner Style', 'uoc') . ' <span>' . __('Please enter Banner Style', 'uoc') . '</span></label>
                                              </li>
                                              <li class="to-field select-style">
                                              ...
                                              <li class="to-field" id="cs_banner_image_value_' . $cs_rand_id . '" style="display:' . $cs_baner_image_display . ';">
                                                <ul class="form-elements" id="' . $i . '_upload">
                                                  <li class="to-field">
                                                    ...
                                                    <label class="browse-icon">
                                                    <input name="banner_field_image' . $i . '" type="button" class="uploadMedia left" value="' . __('Browse', 'uoc') . '"/></label>
                                                  </li>
                                                </ul>
